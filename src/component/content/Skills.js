...
function Skills() {
    ...
    return (_jsxs("div", { className: "item", style: { width: "10vh" }, children: [_jsx("div", { style: { display: 'flex', gap: '0.2vh', flexWrap: 'wrap', justifyContent: "center" }, children: Object.keys(skillsData).map((category, index) => (category !== 'Default' && (_jsx(Button, { id: category, className: `skills-type ${category == activeButton ? "is-active" : ""}`, onClick: () => handleCategoryClick(category), children: category }, index)))) }), _jsx("div", { children: selectedCategory && isSkillCategory(skillsData[selectedCategory]) && (_jsxs("div", { children: [_jsx("h3", { children: selectedCategory }), _jsx("div", { id: skillsData[selectedCategory].id, style: { display: 'flex', gap: '0.2vh', flexWrap: 'wrap', justifyContent: "center" }, children: skillsData[selectedCategory].skills.map((skill, index) => (_jsx("div", { className: "skills-element", children: skill }, index))) }, selectedCategory)] })) })] }));
}
;
